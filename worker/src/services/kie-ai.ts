...
export async function createTask(
  ...
  const prompt = `Edit this photo: change ONLY the lip color to ${lipColor}. Apply the ${lipColor} lipstick fully and opaquely on both upper and lower lips with a glossy satin finish. STRICT CONSTRAINTS: The lipstick must stay precisely within the natural lip boundaries and must NOT extend beyond the lip edges onto the surrounding skin. Do NOT alter the shape, size, structure, or anatomy of the mouth, lips, or teeth. Do NOT add any new elements to the face or skin — no moles, freckles, beauty marks, blemishes, makeup, jewelry, accessories, shadows, highlights, or any other features that were not already present in the original photo. Preserve the person's exact identity, facial features, skin texture, skin tone, and character — the same person must be clearly recognizable. Every pixel outside of the lips (face, skin, hair, eyes, background, lighting, pose) must remain pixel-identical to the original.`;
